            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#verifikasi" data-toggle="tab">Verifikasi 2 Langkah</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
...
function UpdateProfile() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        success: function(data) {
            $('#profile-setting').html(data.aboutData);
        },
        error: function() {
            // Penanganan kesalahan jika terjadi
        }
                   ...
                   <form class="form-horizontal" id="editForm" enctype="multipart/form-data">
                    <input type="hidden" class="form-control id_users" name="id_user" value="<?= $all['id_user'] ?>" id="id_user" placeholder="Name">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="nama_user" value="<?= $all['nama_user'] ?>" id="nama_user" placeholder="Name">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="username" class="col-sm-2 col-form-label">Username</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="username" value="<?= $all['username'] ?>" id="username" placeholder="Email">
                        </div>
                      </div>
                     <div class="form-group row">
        ...
        <div class="custom-control custom-radio">
            ...
            <label for="customRadio2" class="custom-control-label">Perempuan</label>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="number" class="form-control"  name="no_hp" value="<?= $all['no_hp'] ?>" id="nohp" placeholder="Email">
                        </div>
                      </div>
                       <div class="form-group row">
