...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } else if (empty($_POST['deskripsi_ubah']) && empty($_FILES['fileInput_ubah']['name'])) {
    echo "Harap pilih satu, deskripsi atau gambar.";
        ...
        if (!empty($_FILES['fileInput_ubah']['name'])) {
            ...
            // Pengguna tidak mengunggah gambar baru atau memberikan deskripsi, maka gunakan deskripsi yang ada
